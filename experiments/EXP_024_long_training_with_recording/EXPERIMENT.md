...
1. Achieve 100+ consecutive successes (replication of EXP_022/EXP_023)
2. Successfully record videos at all milestone episodes
...
| ... | ... | ... |
| final_model | 10000 | results/models/exp024_model |
