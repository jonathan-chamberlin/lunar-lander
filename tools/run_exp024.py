#!/usr/bin/env python3
"""Run EXP_024: Long training with proper video recording.
...
Usage:
    cd lunar-lander
    .venv-3.12.5/Scripts/python.exe tools/run_exp024.py
"""
...
def main():
    ...
    print("=" * 70)
    print("EXP_024: LONG TRAINING WITH VIDEO RECORDING")
    print("=" * 70)

    # Experiment paths
    exp_dir = Path(__file__).parent.parent / "experiments" / "EXP_024_long_training_with_recording"
    ...
    options = TrainingOptions(
        ...
        memory_limit_mb=6000,  # 6GB limit
    )
